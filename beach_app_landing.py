...
# Configure the landing page - ONLY set if this is the main script
if __name__ == "__main__":
    st.set_page_config(
        page_title="🏖️ Blue Flag Beaches Greece",
        page_icon="🌊",  # Use emoji instead of image file
        layout="centered"
    )
...
def main():
    ...
    # Try to get base64 string of your Blue Flag image
    img_base64 = get_base64_of_image("blue_flag_image.png")

    # Landing page header with Blue Flag image (if available)
    if img_base64:
        st.markdown(f"""
